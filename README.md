...
3. Нужно использовать шаблон https://github.com/bog/bog_calculator для создания своего проекта. Назовите проект, например, lim_market
...
1. Замените в файлах папки все вхождения "bog_calculator" на ваше "lim_market" (имя компании_проект). Это заменит все view.tree файлы
2. Замените в файлах папки все вхождения "bog/calculator" на ваше "lim/market" (имя компании/проект). Это заменит все deploy.yaml файлы
3. Замените в файлах папки все вхождения "bog/bog_calculator" на ваше "lim/lim_market" (имя GitHub/репозиторий). Это заменит все ссылки на репозитоий на ваше
