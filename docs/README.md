...
3. Нужно использовать шаблон https://github.com/bog/calculator для создания своего проекта. Назовите проект, например, lim_market
...
3. Замените в файлах папки все вхождения "bog/calculator" на ваше "lim/lim_market" (имя GitHub/репозиторий). Это заменит все ссылки на репозитоий на ваше
