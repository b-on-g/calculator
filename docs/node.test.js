...
;
	($.$bog_calculator_logo_demo) = class $bog_calculator_logo_demo extends ($.$mol_example_small) {
		Logo(){
	...
	($mol_mem(($.$bog_calculator_logo_demo.prototype), "Logo"));
...
;
	($.$bog_calculator_button_demo) = class $bog_calculator_button_demo extends ($.$mol_example_small) {
		Login(){
	...
	($mol_mem(($.$bog_calculator_button_demo.prototype), "Login"));
	($mol_mem(($.$bog_calculator_button_demo.prototype), "Logout"));
...
;
	($.$bog_calculator_docs) = class $bog_calculator_docs extends ($.$mol_app_demo) {
		menu_title(){
			return "Демонстрации";
		}
		source_prefix(){
			return "https://github.com/bog/bog_calculator/tree/master/";
		}
		sources_uri(){
			return "https://github.com/bog/bog_calculator/";
		}
	};
